...
<body class="bg-[var(--alt-navy-deeper)] text-[var(--alt-beige)] antialiased font-sans">
    ...
    <div x-data="{ open: false }"
        ...
        <div class="relative z-10 w-full max-w-3xl max-h-[85vh] bg-[var(--alt-navy)] border border-[var(--alt-gold)]/20 rounded-2xl overflow-hidden shadow-2xl"
             x-transition:enter="transition ease-out duration-300"
            ...
            <button @click="open = false" class="absolute top-4 right-4 z-20 w-10 h-10 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center transition-colors">
                <svg class="w-6 h-6 text-[var(--alt-beige)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                </svg>
            </button>
            <div class="overflow-y-auto max-h-[85vh] p-8 md:p-10 space-y-8">
                <div>
                    <h2 class="text-2xl md:text-3xl font-bold text-[var(--alt-beige)] mb-2">Europe Revival 2026</h2>
                    <p class="text-[var(--alt-gold)] font-medium">Vision, Values, Principles & Background</p>
                </div>
                <div class="space-y-6 text-[var(--alt-beige-muted)] leading-relaxed">
                    <div>
                        <h3 class="text-lg font-semibold text-[var(--alt-beige)] mb-2">1. Vision</h3>
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-[var(--alt-beige)] mb-2">2. Background</h3>
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-[var(--alt-beige)] mb-2">3. Core Values</h3>
                        <div class="space-y-4 pl-4 border-l-2 border-[var(--alt-gold)]/30">
                            <div>
                                <h4 class="font-semibold text-[var(--alt-beige)]">It's All About Jesus</h4>
                            ...
                            <div>
                                <h4 class="font-semibold text-[var(--alt-beige)]">Presence Over Program</h4>
                            ...
                            <div>
                                <h4 class="font-semibold text-[var(--alt-beige)]">Laid-Down Lives</h4>
                            ...
                            <div>
                                <h4 class="font-semibold text-[var(--alt-beige)]">Family and Belonging</h4>
                            ...
                            <div>
                                <h4 class="font-semibold text-[var(--alt-beige)]">Unity in Diversity</h4>
                            ...
                            <div>
                                <h4 class="font-semibold text-[var(--alt-beige)]">Encounter Leads to Mission</h4>
                            </div>
                        </div>
                    </div>
                    <div>
                        <h3 class="text-lg font-semibold text-[var(--alt-beige)] mb-2">4. Our Prayer</h3>
