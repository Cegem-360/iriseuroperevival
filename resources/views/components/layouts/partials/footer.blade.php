        ...
        <div class="grid md:grid-cols-4 gap-12">
            ...
            <div class="md:col-span-2">
                ...
                <div class="flex items-center gap-4">
                    ...
                    {{-- Instagram icon hidden 2026-08-13: client is still setting up the account. --}}
                    {{-- Dóri gave "Europe revival Budapest 2026" as the profile display name, --}}
                    {{-- but the actual @handle is not yet resolvable — europerevivalbudapest2026 --}}
                    {{-- and the obvious variants all return "Profile not available". Restore --}}
                    {{-- once the real IG URL is confirmed. --}}
                    {{--
                    <a href="https://www.instagram.com/TODO/" target="_blank" rel="noopener" class="w-10 h-10 bg-navy-800 hover:bg-navy-700 rounded-full flex items-center justify-center text-white/60 hover:text-white transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
