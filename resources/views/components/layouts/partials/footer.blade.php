        ...
        <div class="grid md:grid-cols-4 gap-12">
            ...
            <div class="md:col-span-2">
                ...
                <div class="flex items-center gap-4">
                    ...
                    {{-- Client 2026-08-13: IG profile name is "Europe revival Budapest 2026" — verify the exact @handle before shipping. --}}
                    <a href="https://www.instagram.com/europerevivalbudapest2026/" target="_blank" rel="noopener" class="w-10 h-10 bg-navy-800 hover:bg-navy-700 rounded-full flex items-center justify-center text-white/60 hover:text-white transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
