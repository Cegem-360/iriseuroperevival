...
class HomePageSeeder extends Seeder
{
    ...
    protected function seedFaqs(): void
    {
        $faqs = [
            ...
            [
                // Client 2026-08-28: PDF committed at public/downloads/.
                'question' => 'Useful information for your stay',
                'answer' => '<p><a href="/downloads/budapest-useful-information.pdf" target="_blank" rel="noopener" class="text-primary-400 hover:text-primary-300 underline">Download useful information: BUDAPEST – USEFUL INFORMATION FOR YOUR STAY.pdf</a></p>',
                'category' => 'general',
                'sort_order' => 3,
                'is_published' => true,
            ],
